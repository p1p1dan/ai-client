...
> **2026-09-25 已拍板**：用户回复「按建议」，六点全部按下方建议执行；沙箱与拓扑的补充说明见 [决策 001](../plantree/plans/dsh-rebase/decisions/001-route-b-and-scope.md)，后续进度看 [DSH 二开迁移 roadmap](../plantree/plans/dsh-rebase/roadmap.md)。
