...
| [pix/pi-app UI 对齐改造](./plans/pix-ui-alignment/README.md) | **In Progress** | 批次 5 已落地，下一步批次 5.5 | U12 rev.2 跨目录门（full access 解除 envelope 降级，hands-off 不动）+ 终端入口下线（全仓 261 files / 4067 tests 全绿），[U12 rev.2 evidence](./plans/pix-ui-alignment/evidence/2026-09-04-u12-rev2-cross-directory-and-terminal-rail.md) | U13 免绑定会话跨重启可见性（[D04](./plans/pix-ui-alignment/decisions/004-unbound-session-index-visibility.md) 已拍板边界）|
