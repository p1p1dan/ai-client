...
|---|---|---|---|---|
| [Runtime 自主化演进](plans/runtime-evolution/README.md) | In Progress | P0、P2-0 已完成并提交；P1 按 D14 返工中：两轴核心及 UI/传递链已验证，真实项目签收、压缩配对与 Windows 待完成 | `8a71c843`：P0 骨架、六场景 95.01% 基线及证据（2026-09-08） | [P1 剩余 TODO](plans/runtime-evolution/TODO.md) / [验证证据](plans/runtime-evolution/evidence/p1/README.md)；P2/P3 可并行，Q4 已按 D12 收口 |
