...
|---|---|---|---|---|
| [Pi-only application convergence](./plans/pi-backend-migration/README.md) | **In Progress** | Phase E / T34 legacy conversation import | T33 tree/rewind/fork closure | T34 read-only import service |
