...
|---|---|---|---|---|
| [Pi-only application convergence](./plans/pi-backend-migration/README.md) | **In Progress** | Phase H / T37 release gates | T37-c GUI/真账号点验（CDP 探针 11/11，修好 dev 启动、dev worker 启动与 worker stderr 丢弃三个缺陷） | T37-d release notes + 会话变砖缺陷 + CI packaged |
