...
**右栏骨架基线（2026-08-05 D27 后现行）**：[`docs/design/a08-final-context-panel-baseline.html`](../design/a08-final-context-panel-baseline.html) —— D27 拍板回归 A08 骨架，该原件**地位回升为右栏骨架基线**（不再是 T-12~T-15 规格 §7 所称的「历史证据」）；**但内容层三项豁免维持现状**（terminal 维持 surface 不回 BottomDock · context 只放真实字段 · git 维持最小集），差异清单见[T-12~T-15 规格 §7](../plans/2026-08-04-t12-15-surface-spec.md)。落地任务 T-32，**阻塞于 open-q #28**。
