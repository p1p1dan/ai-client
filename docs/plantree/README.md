...
- **活跃 roadmap**：[加固任务树 T001～T033](plans/runtime-hardening/roadmap.md)。任务身份、状态、顺序的唯一权威。
...
| 计划 | 状态 | 当前阶段 | 任务树 | 用户看板 |
|---|---|---|---|---|
| Runtime 加固与收口 | In Progress | 审计落库，批次 A 待开工 | [T001～T033](plans/runtime-hardening/roadmap.md) | [当前进度](进度看板.md) |
