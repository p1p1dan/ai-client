...
| [pix/pi-app UI 对齐改造](./plans/pix-ui-alignment/README.md) | **In Progress** | 批次 4 已落地，下一步批次 5 | U05+U03-b 免绑定开聊 + TUI 解绑，外加 U12 权限档「显示≠实际」缺陷修复（全仓 261 files / 4049 tests 全绿），[U05 evidence](./plans/pix-ui-alignment/evidence/2026-09-03-u05-u03b-unbound-chat.md) · [U12 修复](./plans/pix-ui-alignment/evidence/2026-09-03-u12-tier-spawn-drift-fix.md) | U08-2 思考档补 `off`/`minimal`；未决 [Q13](./plans/pix-ui-alignment/open-questions.md)（免绑定会话跨重启可见性，不阻塞） |
