...
- **Last Landed**:
  ...
  - 文档（2026-07-29 三批）：**A07 中列 Cursor 观感基线产出** [`docs/design/a07-cursor-composer-alignment.html`](../../../design/a07-cursor-composer-alignment.html)——四屏（空态/会话态/Tab 变体/下拉解剖）× Flexoki 亮暗，token 与 globals.css 机器校验一致；**待用户浏览器验收**（重点：Tab 栏带/不带、运行位置只读 chip），通过后 T-27/T-28 方可施工
