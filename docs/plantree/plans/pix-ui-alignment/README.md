...
> **状态**：Planning（未开工）
>
> **前置**：[Pi-only 收敛计划](../pi-backend-migration/README.md) 的 T37 发版门禁收口后才开工（[D01](./decisions/001-style-depth-and-sequencing.md)）。
...
| [open-questions.md](./open-questions.md) | 未解决问题（不是任务）；**Q01–Q07 全部已闭**，结论均指向 decisions/evidence |
...
3. [D01](./decisions/001-style-depth-and-sequencing.md)。
