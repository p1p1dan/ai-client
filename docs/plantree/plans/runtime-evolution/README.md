...
| 8 | P5-2（含 P5-2-0～7） | subagent 整体复刻 | 🟡 进行中（2026-09-12）。八个子节点已完成 0～3：探针门禁、定义与模型目录、Task* 后台编排、权限与工具能力。剩 4～7（会话/事件/usage、管理 UI 与迁移、运行与历史展示、SA01～22 全量签收）与 BrowserPreview 的 Electron 那一半。[记录](evidence/p5-2/README.md) · [基线](topics/p5-2-0-baseline.md) |
...
| P5-2 | subagent 整体复刻 | 🟡 八个子节点完成四个（0～3），4～7 未开始；[记录](evidence/p5-2/README.md) |
