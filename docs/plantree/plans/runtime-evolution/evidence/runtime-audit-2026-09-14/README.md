...
| P1-0 | ✅ | 完成（小瑕疵） | 长驻子进程路径成熟度低；dispose 错误屏蔽。已修（T022，`84ac35e0` + `117d97a9`）；core-host-05 stderr 预算归 T013 |
| P1-1 | ✅ | 完成 | 无 |
| P1-2 | ✅ | 有缺口 | 截断尾巴、单行死循环、空结果、BOM、TSD O(n²)。前四项已修（T012，`439ab922`）；TSD 归 T013 |
