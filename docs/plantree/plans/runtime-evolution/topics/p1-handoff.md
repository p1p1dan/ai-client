...
本文件是 P1 开工时的历史范围、依赖和接续说明，下文时态只描述 2026-09-08/09，不维护实时完成状态。当前节点状态统一见[核心任务树 P1](../README.md#p1)，用户交接见[进度看板](../../../进度看板.md)。
...
P1 D14 实现已提交 `27ff2020`，主动压缩配对已提交 `2ae6f209`；提交和现场验收状态以核心任务树为准。
...
Windows 随包 Node、进程树、加密机、P4 GUI 和真实项目策略的证据按版本归档，当前是否已签收不在本文件维护。
