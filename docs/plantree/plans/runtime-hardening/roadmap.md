...
- 批次 B 第四波已全部落地（T017 + T022）并推送。第五波 T034 + T013 待派；用户指示第四波提交推送后停下。逐波记录见 [evidence/batch-b-2026-09-14.md](evidence/batch-b-2026-09-14.md)；批次 A 记录见 [evidence/batch-a-2026-09-14.md](evidence/batch-a-2026-09-14.md)。
