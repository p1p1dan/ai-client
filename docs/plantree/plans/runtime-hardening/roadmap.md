...
- **批次 B 已全部落地**（T012～T024 + T034 / T035，八波，2026-09-14～15），第五～八波随文档提交一并推送。下一步批次 C（T025～T028）待派。Q009 / Q010 / Q011 已拍板为决策 009 / 010 / 011（009 的代码半边已落地；011 实测 managed TUI 公司渠道可用并加 e2e 守卫，不封其他渠道）。逐波记录见 [evidence/batch-b-2026-09-14.md](evidence/batch-b-2026-09-14.md)；批次 A 记录见 [evidence/batch-a-2026-09-14.md](evidence/batch-a-2026-09-14.md)。
