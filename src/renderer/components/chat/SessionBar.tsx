              ...
              <>
                ...
                >
                  <button
                    ...
                    className="flex h-7 max-w-40 min-w-0 shrink-0 items-center gap-1.5 rounded-full border px-3 text-ui text-muted-foreground hover:bg-accent/50 hover:text-foreground transition-colors whitespace-nowrap"
                  ...
                  >
                    ...
                    {activeProvider ? (
                      <span className="min-w-0 truncate">
                        {truncateProviderName(activeProvider.name)}
                      </span>
                    ) : null}
                  </button>
