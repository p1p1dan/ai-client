 ...
 *
 * ⚠️ Never add `overflow-hidden` here: it would make this element a containing
 * block and silently switch off the pinned bubble band's `position: sticky`
 * (the standing prohibition in this file's head note).
 */
