 ...
 *
 * Pi-only registration always lets Main stamp the row as Pi. A missing live row
 * sends no runtime guess, and Main rejects an existing explicit legacy binding
 * before writing.
 */
