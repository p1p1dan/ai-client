  ...
  return (
    <div
      className={cn(
        ...
        // D25: explicit font-mono on the highlighted branch too — shiki's
        // inline styles carry colors only; the family must not depend on
        // preflight staying implicit (mirrors the fallback branch above).
        '[&>pre]:!bg-transparent [&>pre]:p-4 [&>pre]:m-0 [&>pre]:font-mono [&>pre]:text-sm [&>pre]:leading-snug [&>pre]:w-fit [&>pre]:min-w-full',
