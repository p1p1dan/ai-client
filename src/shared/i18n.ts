...
export const zhTranslations: Record<string, string> = {
  ...
  'Enable Integration': '启动 Claude-AI Client 集成',
  ...
  'Default permission mode for new Claude Code sessions': '新建 Claude Code 会话的默认权限模式',
  'Default approval policy for new Codex sessions': '新建 Codex 会话的默认审批策略',
  'Default sandbox mode for new Codex sessions': '新建 Codex 会话的默认沙箱模式',
