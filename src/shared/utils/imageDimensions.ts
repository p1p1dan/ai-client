 ...
 *
 * Shared so the runtime `read` tool can report the same dimensions for an image
 * file; `renderer/components/chat/imageDimensions.ts` re-exports it.
 *
 * §12 verification first: renderer/components/chat/__tests__/imageDimensions.test.ts.
 */
